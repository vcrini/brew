...
[homebrew/core](https://github.com/vcrini/homebrew-core). But there are
...
([homebrew/core](https://github.com/vcrini/homebrew-core)) must be open-source
and either built from source or produce cross-platform binaries (e.g. Java, Mono).
Binary-only formulae should go to
[homebrew/cask](https://github.com/vcrini/homebrew-cask).
...
don’t want those things in Homebrew. Encourage upstream projects to build and support a `.app` that can be distributed by [homebrew/cask](https://github.com/vcrini/homebrew-cask) (and used without it, too).
