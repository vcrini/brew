...
describe Cask::Cmd::Info, :cask do
  ...
  it "displays some nice info about the specified Cask" do
    expect {
      ...
      Not installed
      From: https://github.com/vcrini/homebrew-cask/blob/master/Casks/local-caffeine.rb
      ==> Name
      None
      ==> Artifacts
      Caffeine.app (App)
  ...
  it "prints auto_updates if the Cask has `auto_updates true`" do
    expect {
      ...
      Not installed
      From: https://github.com/vcrini/homebrew-cask/blob/master/Casks/with-auto-updates.rb
      ==> Name
      AutoUpdates
      ==> Artifacts
      AutoUpdates.app (App)
  ...
  describe "given multiple Casks" do
    let(:expected_output) {
      <<~EOS
        ...
        Not installed
        From: https://github.com/vcrini/homebrew-cask/blob/master/Casks/local-transmission.rb
        ==> Name
        Transmission
        ==> Artifacts
  ...
  it "prints caveats if the Cask provided one" do
    expect {
      ...
      https://example.com/local-caffeine
      Not installed
      From: https://github.com/vcrini/homebrew-cask/blob/master/Casks/with-caveats.rb
      ==> Name
      None
      ==> Artifacts
      Caffeine.app (App)
  ...
  it 'does not print "Caveats" section divider if the caveats block has no output' do
    expect {
      ...
      https://example.com/local-caffeine
      Not installed
      From: https://github.com/vcrini/homebrew-cask/blob/master/Casks/with-conditional-caveats.rb
      ==> Name
      None
      ==> Artifacts
      Caffeine.app (App)
  ...
  it "prints languages specified in the Cask" do
    expect {
      ...
      https://example.com/local-caffeine
      Not installed
      From: https://github.com/vcrini/homebrew-cask/blob/master/Casks/with-languages.rb
      ==> Name
      None
      ==> Languages
      zh, en-US
  ...
  it 'does not print "Languages" section divider if the languages block has no output' do
    expect {
      ...
      https://example.com/local-caffeine
      Not installed
      From: https://github.com/vcrini/homebrew-cask/blob/master/Casks/without-languages.rb
      ==> Name
      None
      ==> Artifacts
      Caffeine.app (App)
